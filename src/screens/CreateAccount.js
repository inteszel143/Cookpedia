...
export default function CreateAccount() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-white">
            ...
            >
                <View style={{ height: hp(50), marginHorizontal: wp(4) }}
                ...
                >
                    ...
                    <View className="items-center justify-center mt-8">
                        <Text
                            ...
                            className="text-2xl text-[#F74848]">Sign up Successful!</Text>
                    ...
                    <SkypeIndicator color='#F74848' size={50} />
                </View>
            </Modal>
            ...
            >
                ...
                <View className="px-5 pt-6">
                    <View className="flex-row items-center">
                        <Text
                            ...
                            className="text-2xl">Create an Account 🔐 </Text>
                    </View>
                    <Text
                ...
                <View className="px-4 mt-5">
                    <View className="mt-2">
                        <Text
                            ...
                            className="text-base">Username</Text>
                        <TextInput
                ...
                {/* REMEMBER */}
                <View className="px-4 mt-4 flex-row items-center space-x-2">
            ...
            >
                <TouchableOpacity
                    ...
                    <Text
                        style={{ fontFamily: 'PoppinsMedium', fontSize: wp(4.2) }}
                        className="text-white text-lg">Sign up</Text>
                </TouchableOpacity>
            </Animated.View>
